...
(function($) {
    var allCities = ['北京|beijing|bj', '上海|shanghai|sh', '重庆|chongqing|cq', '深圳|shenzhen|sz', '广州|guangzhou|gz', '杭州|hangzhou|hz',
        ...
        '张家界|zhangjiajie|zjj', '舟山|zhoushan|zs', '郑州|zhengzhou|zz', '中卫|zhongwei|zw', '芷江|zhijiang|zj', '湛江|zhanjiang|zj', '衡阳|hengyang|hy', '邵阳|shaoyang|sy', '娄底|loudi|ld', '永州|yongzhou|yz',
        '吉首|jishou|js', '湘潭|xiangtan|xt', '株洲|zhuzhou|zz'
    ];
